...
public class Admin_User_Data extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Admin_User_DataModel> userDataModelList = fetchUserData();
        ...
        BTN_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animatoo.INSTANCE.animateSlideRight(Admin_User_Data.this);
            }
        });
        // TRANSACTION HISTORY
...
//--------------------------------------------------------------------------------------------------
    ...
    private List<Admin_User_DataModel> fetchUserData() {
        List<Admin_User_DataModel> dataList = new ArrayList<>();
        ...
        databaseReference.child("user").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren())
                {
                    ...
                    {
                        Admin_User_DataModel data = dataSnapshot.getValue(Admin_User_DataModel.class);
                        dataList.add(data);
                    }
                }
            }
