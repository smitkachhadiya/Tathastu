        ...
        public void bind(Admin_NGO_DataModel user) {
            ...
            userDetailButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("ngoId",user.getNgoId());
                            ...
                            btnExitYes.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (position != RecyclerView.NO_POSITION) {
                                        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("ngo");
                                        databaseRef.child(user.getNgoId()).removeValue()
