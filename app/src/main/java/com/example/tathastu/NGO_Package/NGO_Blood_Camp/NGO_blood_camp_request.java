...
//                startActivity(i);
                ...
                finish();
                Animatoo.INSTANCE.animateSlideRight(NGO_blood_camp_request.this);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!isInternetAvailable()) {
                    ...
                    if (fname.isEmpty() || sdate.isEmpty() || edate.isEmpty() || mno.isEmpty() || email.isEmpty() || address.isEmpty() || desc.isEmpty()) {
                        ...
                        DatabaseReference userdata = FirebaseDatabase.getInstance().getReference("ngo_blood");
                        ...
                        userdata.child(key).setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        Toast.makeText(NGO_blood_camp_request.this, "Request Created Successfuly", Toast.LENGTH_SHORT).show();
                                        Intent i = new Intent(NGO_blood_camp_request.this, NGO_blood_camp_history.class);
                                        startActivity(i);
                                        Animatoo.INSTANCE.animateSlideLeft(NGO_blood_camp_request.this);
