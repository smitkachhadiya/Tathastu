...
public class NGO_food_camp_historyadapter extends RecyclerView.Adapter<NGO_food_camp_historyadapter.ViewHolder> {
    ...
    NGO_food_camp_historyadapter(NGO_food_camp_history context, ArrayList<NGO_food_History_model> donor){
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        NGO_food_History_model data = donor.get(i);
            ...
            private void showDeleteConfirmationDialog() {
                ...
                btnExitYes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ngo_food").child(data.getKey());
