...
public class NGO_EduCamp_Request extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngo_edu_camp_request);
        ...
        linear_layout_food = findViewById(R.id.linear_layout_edu);
...
//                startActivity(i);
                ...
                finish();  Animatoo.INSTANCE.animateSlideRight(NGO_EduCamp_Request.this);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!isInternetAvailable()) {
                    ...
                    if (fname.isEmpty() || sdate.isEmpty() || edate.isEmpty() || mno.isEmpty() || email.isEmpty() || address.isEmpty() || desc.isEmpty()) {
                        ...
                        DatabaseReference userdata = FirebaseDatabase.getInstance().getReference("ngo_education");
                        ...
                        userdata.child(key).setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        Toast.makeText(NGO_EduCamp_Request.this, "Request Created Successfuly", Toast.LENGTH_SHORT).show();
                                        Intent i = new Intent(NGO_EduCamp_Request.this, NGO_edu_camp_History.class);
                                        startActivity(i);
                                        Animatoo.INSTANCE.animateSlideLeft(NGO_EduCamp_Request.this);
