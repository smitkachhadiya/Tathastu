...
public class NGO_edu_camp_historyAdapter extends RecyclerView.Adapter<NGO_edu_camp_historyAdapter.ViewHolder>{
    ...
    NGO_edu_camp_historyAdapter(Context context, ArrayList<NGO_food_History_model> donor){
            ...
            private void showDeleteConfirmationDialog() {
                ...
                btnExitYes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ngo_education").child(data.getKey());
