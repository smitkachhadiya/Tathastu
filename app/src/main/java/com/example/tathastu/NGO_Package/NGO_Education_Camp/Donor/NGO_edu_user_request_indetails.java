...
public class NGO_edu_user_request_indetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngo_edu_user_request_indetails);
        ...
        but_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish(); Animatoo.INSTANCE.animateSlideRight(NGO_edu_user_request_indetails.this);
            }
        });
