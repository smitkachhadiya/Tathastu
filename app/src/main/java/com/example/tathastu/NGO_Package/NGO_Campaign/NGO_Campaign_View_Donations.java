...
//                startActivity(i);
                ...
                finish(); Animatoo.INSTANCE.animateSlideRight(NGO_Campaign_View_Donations.this);
            }
        });
        ...
        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if(snapshot.hasChild("Donations")){
                    ...
                    AlertDialog.Builder builder= new AlertDialog.Builder(new ContextThemeWrapper(NGO_Campaign_View_Donations.this,R.style.CustomAlertDialog));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Animatoo.INSTANCE.animateSlideRight(NGO_Campaign_View_Donations.this);
        finish();
    }
