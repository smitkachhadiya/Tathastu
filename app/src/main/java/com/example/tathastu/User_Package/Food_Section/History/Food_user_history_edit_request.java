...
btn_back.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        finish();
        Animatoo.INSTANCE.animateSlideRight(Food_user_history_edit_request.this);
    }
});
                        ...
                        if (snapshot.exists()) {
                            ...
                            reference.child(key).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    startActivity(i);
                                    Animatoo.INSTANCE.animateSlideLeft(Food_user_history_edit_request.this);
                                    Toast.makeText(Food_user_history_edit_request.this, "Updated Successfully.", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Food_user_history_edit_request.this, "Data is Not Updated.", Toast.LENGTH_SHORT).show();
