    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animatoo.INSTANCE.animateSlideRight(Education_Selection_Screen.this);
            }
        });
        ...
        BTN_edu_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(i);
                Animatoo.INSTANCE.animateSlideLeft(Education_Selection_Screen.this);
            }
        });
        ...
        BTN_edu_camp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Education_Selection_Screen.this, Edu_Donation_Camp.class);
                startActivity(i);
                Animatoo.INSTANCE.animateSlideLeft(Education_Selection_Screen.this);
            }
        });
