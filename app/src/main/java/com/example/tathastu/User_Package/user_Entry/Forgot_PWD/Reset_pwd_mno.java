...
public class Reset_pwd_mno extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_pwd_mno);

        forgot_mno =findViewById(R.id.forgot_mno);
        forgot_send_OTP =findViewById(R.id.forgot_send_OTP);
        ...
        BTN_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animatoo.INSTANCE.animateSlideRight(Reset_pwd_mno.this);
            }
        });
                                ...
                                if (snapshot.exists()) {
                                    ...
                                    for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                                        ...
                                        if (("+91" + mob).equals(mno)) {
                                            Toast.makeText(Reset_pwd_mno.this, "Mobile number registered yet", Toast.LENGTH_SHORT).show();
                                            flag[0] = 1;
                                            break;
                                        } else {
                                            flag[0] = 0;
                                    ...
                                    if (flag[0] == 1) {
                                        ...
                                        String password=getset[0].getPassword();

                                        Intent i = new Intent(Reset_pwd_mno.this, Reset_pwd_OTP.class);
                                        ...
                                        startActivity(i);
                                        Animatoo.INSTANCE.animateSlideLeft(Reset_pwd_mno.this);
                                    } else {
                                        Toast.makeText(Reset_pwd_mno.this, "you haven't registered yet", Toast.LENGTH_SHORT).show();
