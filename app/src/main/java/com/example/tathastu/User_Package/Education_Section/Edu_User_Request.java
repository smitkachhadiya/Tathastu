...
public class Edu_User_Request extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edu_user_request);

        edtName = findViewById(R.id.txt_edu_name);
        edtmno = findViewById(R.id.txt_edu_mno);
        edtemail = findViewById(R.id.txt_edu_email);
        edtaddress = findViewById(R.id.txt_edu_location);
        edtdesc = findViewById(R.id.txt_edu_note);
        ...
        chk_user = findViewById(R.id.chk_ex_edu_user);
        ...
        FloatingActionButton BTN_back=findViewById(R.id.BTN_edu_req_back);
...
//                startActivity(i);
                finish();
                Animatoo.INSTANCE.animateSlideRight(Edu_User_Request.this);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!isInternetAvailable()) {
                    ...
                    if (fname.isEmpty() || mno.isEmpty() || email.isEmpty() || address.isEmpty() || desc.isEmpty()) {
                        ...
                        DatabaseReference userdata = FirebaseDatabase.getInstance().getReference("education");
                        ...
                        userdata.child(key).setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        Toast.makeText(Edu_User_Request.this, "Request Created Successfuly", Toast.LENGTH_SHORT).show();
                                        Intent i = new Intent(Edu_User_Request.this, Edu_user_History.class);
                                        startActivity(i);
                                        Animatoo.INSTANCE.animateSlideLeft(Edu_User_Request.this);
finish();
                                    }
                                })
