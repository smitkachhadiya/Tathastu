...
public class Food_user_allDonors_indetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_user_all_donors_indetails);
        ...
        but_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Animatoo.INSTANCE.animateSlideRight(Food_user_allDonors_indetails.this);
            }
        });
