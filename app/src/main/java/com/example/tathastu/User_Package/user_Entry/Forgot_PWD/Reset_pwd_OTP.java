package com.example.tathastu.User_Package.user_Entry.Forgot_PWD;
...
public class Reset_pwd_OTP extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_pwd_otp);
        ...
        forgot_submit_OTP =findViewById(R.id.forgot_submit_OTP);
        ...
        BTN_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animatoo.INSTANCE.animateSlideRight(Reset_pwd_OTP.this);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!isInternetAvailable()) {
                    ...
                    if (otp.isEmpty()) {
                        ...
                        forgotpwdmail(fname,lname,email,mno,pwd);
    ...
    private void initiateMailOtp(String fname1) {
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(Reset_pwd_OTP.this, "Error Occurred : ", Toast.LENGTH_SHORT).show();
                            }
                        });
                        e.printStackTrace();
                    }
        ...
        Toast.makeText(Reset_pwd_OTP.this, "Otp Mail Sent Successfully.", Toast.LENGTH_SHORT).show();

    }

    public void forgotpwdmail(String fname, String lname, String email, String mno, String pwd) {

        Intent intent = new Intent(Reset_pwd_OTP.this, Login_Screen.class);
        ...
        try {
            ...
            String registerMessage = "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">\n" +
                    ...
                    "                        <h2 style=\"color: #ffffff;\">Your Tathastu Credintials</h2>\n" +
                    "                    </td>\n" +
                    "                </tr>\n" +
                    "                <tr>\n" +
                    "                    <td bgcolor=\"#ffffff\" style=\"padding: 10px; color: black;\">\n" +
            ...
            Toast.makeText(Reset_pwd_OTP.this, "Error Occurred : " + e, Toast.LENGTH_SHORT).show();
        }
        ...
        Toast.makeText(Reset_pwd_OTP.this, "Register Mail Sent Successfully.", Toast.LENGTH_SHORT).show();
