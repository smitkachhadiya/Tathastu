package com.example.tathastu.User_Package.Reset_PWD;
...
public class Reset_Pwd_Screen extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                Animatoo.INSTANCE.animateSlideRight(Reset_Pwd_Screen.this);
            }
        });
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(Reset_Pwd_Screen.this, "Password Updated Successfully !!", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(Reset_Pwd_Screen.this, "Failed To Update Password !!", Toast.LENGTH_SHORT).show();
                                    }
